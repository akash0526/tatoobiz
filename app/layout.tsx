...
export const metadata: Metadata = {
  ...
  description: "Nepal's premier tattoo studio in Butwal. Specializing in Hindu mythology art, mandalas, sacred geometry, black & gray realism, fine line & piercing. LGBTQ+ friendly.",
  icons: {
    icon: "/favicon.ico",
  },
  openGraph: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${cinzel.variable} ${cinzelDecorative.variable} ${cormorant.variable} ${raleway.variable} antialiased`}>
